...
export default function Hero() {
  ...
  function scrollHandler() {
    ...
    const scrollProgress = Math.min(
      window.scrollY / (window.innerHeight * 5 - window.innerHeight),
      1
    );
  ...
  return (
    <div className="h-[500vh]">
      <div className="sticky flex flex-col items-center justify-center top-0 left-0 h-screen w-full overflow-hidden">
        <div className="absolute size-full overflow-hidden flex items-center justify-center">
          <video
            ...
            data-video-basepath="/105/media/us/macbook-air/2024/abecf8fa-b944-4698-94ce-14616e166bff/anim/hero/"
        ...
        <div
          className="flex-col max-w-[60rem] gap-10 absolute top-[calc(100vh-300px)]"
          style={{ display: progress > 0.81 ? "flex" : "none" }}
        >
          <Text />
        </div>
      </div>
